...
{
public:
  bool setup(File input, uint8_t *mjpeg_buf, M5GFX *tft, bool multiTask)
  {
    _input = input;
...
private:
  ...
  {
    static int flip = 0;
    int numPixels = jdec->width * h;
    MjpegClass *me = (MjpegClass *)jdec->device;
    if (y == 0) {
      me->_tft->setAddrWindow(me->_jpg_x, me->_jpg_y, me->_out_width, me->_out_height);
    }
    ...
    me->_tft->pushPixelsDMA((lgfx::v1::swap565_t*)(me->_out_buf), me->_out_width * h);
